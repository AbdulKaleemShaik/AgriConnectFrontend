...
function ProfilePage() {
    ...
    const fetchUserProfile = async () => {
      try {
        ...
        setFormData({
          ...
          profileImage: userData.profileImage, // Assuming profileImage URL
        });
      } catch (error) {
  ...
  const handleProfileSubmit = async (e) => {
    ...
    try {
      await axiosInstance.post('/admin/update-profile', profileFormData, {
        ...
        <Card sx={{ p: 4 }} className={styles.card}>
          ...
          <Grid container spacing={3} alignItems="center">
            <Grid item xs={12} sm={4} align="center">
              <Avatar
                src={formData.profileImage ? `${import.meta.env.VITE_API_URL}/img/profile_img/${formData.profileImage}` : profilePhoto}
                alt="Profile"
            ...
            <Grid item xs={12} sm={8}>
              <form onSubmit={handleProfileSubmit}>
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={12}>
                    <Button variant="contained" component="label" className={styles.uploadBtn}
